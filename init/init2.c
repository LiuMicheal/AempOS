...
void main(int arg,char *argv[])
{
	...
	//延时:init1需要等待cpu0执行restart_initial进去调度,才能把hd_service启动起来
	int j=100000000;
	for(;j>0;j--);
	...
	char filename[MAX_FILENAME_LEN+1] = "I2-0";	//modified by mingxuan 2019-3-11
	char bufr[5];
	const char bufw[] = "C2-0"; //modified by mingxuan 2019-3-12
