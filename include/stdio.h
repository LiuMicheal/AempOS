...
/*
int msgget(int key); //added by mingxuan 2019-5-13
int msgctl(int msqid, int cmd); //added by mingxuan 2019-5-13
int msgsnd(int msqid, void *ptr, int size, int flag); //added by mingxuan 2019-5-13
int msgrcv(int msqid, void *ptr, int size, int type, int flag); //added by mingxuan 2019-5-13
*/