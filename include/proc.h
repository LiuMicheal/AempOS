 ...
 */
//#define INIT_STACK_SIZE (1024 * 8)	//new kernel stack is 8kB	//deleted by mingxuan 2019-1-21
#define INIT_STACK_SIZE 1024 * 4	//new kernel stack is 4KB	//modified by mingxuan 2019-1-21
...
//#define NR_PCBS	8	//deleted by mingxuan 2019-2-28
//#define NR_PCBS	16	//增加PCB的容量	//modified by mingxuan 2019-2-28
#define NR_PCBS		64	//增加PCB的容量	//modified by mingxuan 2019-3-3
//#define NR_TASKS	6	//TestA~TestC + hd_service	//deleted by mingxuan 2019-2-27
//#define NR_TASKS	4	//TestA~TestD	//modified by mingxuan 2019-2-27
#define NR_TASKS	12  //预留12个，4个用于load_balance，1个TestA，1个TestB，1个hd_service，1个kb_service 	//modified by mingxuan 2019-4-11
//efine NR_K_PCBS	4	//no K_PCB is empty now

//#define NR_CPUS		2	//先简单设置一个宏，表示CPU个数，CPU个数本质上是由加电自检得到的 //added by mingxuan 2019-2-27 //deleted by mingxuan 2019-3-13
//#define NR_CPUS		1		//modified by mingxuan 2019-3-6
//#define NR_INITIALS NR_CPUS	//added by mingxuan 2019-2-27 //deleted by mingxuan 2019-3-13

/* 和init进程的pid有关的宏 */
//added by mingxuan 2019-3-13
#define NR_INITIALS		NCPU

/* //deleted by mingxuan 2019-4-11
#define INITIAL_PID		0x4 //cpu0上的init进程的pid
#define INITIAL1_PID    0x5 //cpu1上的init1进程的pid
#define INITIAL2_PID	0x6 //cpu2上的init1进程的pid
#define INITIAL3_PID    0x7 //cpu3上的init1进程的pid
*/
//modified by mingxuan 2019-4-11
#define INITIAL_PID		0x0 //cpu0上的init进程的pid
#define INITIAL1_PID    0x1 //cpu1上的init1进程的pid
#define INITIAL2_PID	0x2 //cpu2上的init1进程的pid
#define INITIAL3_PID    0x3 //cpu3上的init1进程的pid
//~xw

/* 负载均衡相关 */
//added by mingxuan 2019-4-12
#define NR_MIGRATIONS	NCPU

#define MIGRATION_PID	0x4
#define MIGRATION1_PID  0x5
#define MIGRATION2_PID  0x6
#define MIGRATION3_PID  0x7

#define NR_STABLE_PROC	0x3 //每颗CPU的就绪队列上不做移动的进程数量
							//每颗CPU的就绪队列的前3个proc分别为0#、migration、init，这3个不做移动



//#define NR_CPUS	1		//numbers of cpu. added by xw, 18/6/1	//deleted by mingxuan 2019-2-27
...
//enum proc_stat 		{IDLE,READY,SLEEPING,KILLED,RUNNING};			//modified by mingxuan 2019-1-22
enum proc_stat 			{IDLE,READY,SLEEPING,KILLED,RUNNING,WAITING};	//移植进程间通信时添加 //modified by mingxuan 2019-5-13

//#define NR_CHILD_MAX	(NR_PCBS-NR_K_PCBS-1)    //定义最多子进程/线程数量	//add by visual 2016.5.26 //deleted by mingxuan 2019-3-14
#define NR_CHILD_MAX	(NR_PCBS-NR_TASKS-1)    //定义最多子进程/线程数量	//modified by mingxuan 2019-3-14
...
typedef struct s_proc {
	...
	int base_ticks;			   //ticks的基准值，即于渊Orange'S中的priority变量	//modified by mingxuan 2019-3-5

    int priority;			   //不再表示ticks的基准值，而表示进程的优先级	
							   //priority的值越小，越优先被调度			//modified by mingxuan 2019-3-5

	u32 pid;                   /* process id passed in from MM */
	char p_name[16];           /* name of the process */
	
	enum proc_stat stat;		//add by visual 2016.4.5
	int waiting_to_ready;		//移植进程间通信时添加 //added by mingxuan 2019-5-13 
...
#define STACK_SIZE_TTY		0x1000	//added by mingxuan 2019-3-8
...
#define TASK_FLAG 0x0
#define USER_FLAG 0x1
