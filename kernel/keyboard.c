...
PUBLIC void init_keyboard()
{
	...
	ctrl_l	= ctrl_r  = 0;
		...
		//多核情形所特有
        //ioapicenable(KEYBOARD_IRQ, 0);	 //打开ioapic的键盘中断引脚，设置cpu0接受硬盘中断	//added by mingxuan 2019-3-7
		ioapicenable(KEYBOARD_IRQ, CPU0_ID); //打开ioapic的键盘中断引脚，设置cpu0接受硬盘中断	//modified by mingxuan 2019-5-7
