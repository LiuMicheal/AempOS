...
{
	init_8259A();	//deleted by mingxuan 2019-3-4
...
PUBLIC void exception_handler(int vec_no, int err_code, int eip, int cs, int eflags)
{
	...
	//added by xw, 18/12/19
	//p_proc_current->task.stat = KILLED;	//deleted by mingxuan 2019-1-16
	proc->task.stat = KILLED;				//modified by mingxuan 2019-1-16
